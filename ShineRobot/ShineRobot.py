...
from ShineRobot_ui import Ui_MainWindow
...
from ShineRobot_Socket import SocketServer, SocketServerCloseClient, SocketClient, SocketCommunicate
...
class SocketWidgetStruct:
    """
    class for stack status of socket widgets
    """
    def __init__(self):
        self.send_fun = None
...
class MyMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def record_socket_communication_result(self, str_record: str):
        ...
        self.textEdit_socket_Log.append(_str_time + str_record)
        self.textEdit_socket_Log.moveCursor(QTextCursor.End)
